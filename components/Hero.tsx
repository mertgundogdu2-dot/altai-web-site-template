...
export default function Hero() {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center text-center px-4 pt-16" style={{ background: `linear-gradient(135deg, var(--secondary) 0%, ${config.design.primaryColor}22 100%)` }}>
      <div className="container-main animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#iletisim" className="btn-primary text-lg px-8 py-4">
            {config.content.ctaButton}
          </a>
          <a href="#hizmetler" className="px-8 py-4 rounded-lg border-2 border-white/30 text-white hover:bg-white/10 transition font-semibold">
            Hizmetlerimiz
          </a>
        </div>
